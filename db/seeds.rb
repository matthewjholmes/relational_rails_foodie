...
produce4 = Produce.create(name: "Apples", seasonal: false, quantity: 450, farmers_market_id: farmers_market1.id)
produce5 = Produce.create(name: "Peaches", seasonal: true, quantity: 600, farmers_market_id: farmers_market1.id)
produce6 = Produce.create(name: "Bananas", seasonal: false, quantity: 300, farmers_market_id: farmers_market1.id)
produce7 = Produce.create(name: "Rice", seasonal: false, quantity: 1300, farmers_market_id: farmers_market1.id)
produce8 = Produce.create(name: "Black Beans", seasonal: false, quantity: 700, farmers_market_id: farmers_market1.id)
produce9 = Produce.create(name: "Lentils", seasonal: false, quantity: 400, farmers_market_id: farmers_market1.id)
